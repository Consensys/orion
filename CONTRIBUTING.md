...
* **Perform a cursory search of open issues** 
...
start by explaining how you started Orion, e.g. which command exactly you used in the terminal, 
...
* **Which version of the software are you using?** You can get the exact version by running `Orion -v` in your terminal.
...
* **What version of Java are you running?** You can get the exact version by looking at the Orion 
...
When you've identified an issue you'd like to work on, ping us on [Discord](README.md#chat) and we'll assign it to you. 
...
1. [**Fork the repository**](https://github.com/PegaSysEng/Orion/fork).
...
1. **Create a pull-request** (PR) on the Orion repository.  
...
you can **"squash and merge"** your PR and you're done. You contributed to Orion! Thanks!
