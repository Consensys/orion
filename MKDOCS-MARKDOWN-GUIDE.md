...
Orion documentation is written using [Markdown](https://daringfireball.net/projects/markdown/) syntax.
...
The [/docs](/docs) directory in the Orion repository contains all the documentation that 
...
linking GitHub to the [readthedocs.org] site when you merge a pull-request in the master branch of Orion.
...
To preview Orion documentation locally: 
