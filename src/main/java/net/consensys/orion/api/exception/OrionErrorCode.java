...
public enum OrionErrorCode {
  ...
  ENCLAVE_DECRYPT("0x040001"),
  ENCLAVE_DECRYPT_WRONG_PRIVATE_KEY("0x040002"),
  ENCLAVE_ENCRYPT("0x040003"),
  ENCLAVE_ENCRYPT_COMBINE_KEYS("0x040004"),
  ENCLAVE_MISSING_PRIVATE_KEY_PASSWORD("0x040005"),
  ENCLAVE_NO_MATCHING_PRIVATE_KEY("0x040006"),
  ENCLAVE_NOT_PAYLOAD_OWNER("0x040007"),
  ENCLAVE_UNSUPPORTED_ALGORITHM("0x040008"),
  ENCLAVE_UNSUPPORTED_PRIVATE_KEY_TYPE("0x040009"),
  ENCLAVE_UNSUPPORTED_PUBLIC_KEY_TYPE("0x04000A"),
  ENCLAVE_UNSUPPORTED_STORAGE_ALGORITHM("0x04000B"),
  ENCLAVE_READ_PASSWORDS("0x04000C"),
  ENCLAVE_READ_PUBLIC_KEY("0x04000D"),
  ENCLAVE_STORAGE_ENCRYPT("0x04000E"),
  ENCLAVE_STORAGE_DECRYPT("0x04000F"),
  ENCLAVE_WRITE_PUBLIC_KEY("0x040010"),
