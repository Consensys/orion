  ...
  public static byte[] serialize(HttpContentType contentType, Object obj) {
    try {
      switch (contentType) {
        ...
        default:
          throw new OrionException(OrionErrorCode.OBJECT_JSON_SERIALIZATION, new NotSerializableException());
      }
    } catch (final IOException io) {
      throw new OrionException(OrionErrorCode.OBJECT_JSON_SERIALIZATION, io);
    }
  }
  ...
  public static <T> T deserialize(HttpContentType contentType, Class<T> valueType, byte[] bytes) {
    try {
      switch (contentType) {
        ...
        default:
          throw new OrionException(OrionErrorCode.OBJECT_JSON_DESERIALIZATION, new NotSerializableException());
      }
    } catch (final Exception e) {
      throw new OrionException(OrionErrorCode.OBJECT_JSON_DESERIALIZATION, e);
    }
  }
