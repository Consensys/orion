...
public class SendReceiveTest {
  ...
  /**
   * Single node sends and receives using different keys. Ensures the sender key can view their
   * transaction when not also the recipient key.
   */
  @Test
  ...
  // TODO test key ordering / i.e. reversed
  // TODO test also adding the sender to the sendTo list
