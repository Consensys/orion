...
public class TofuNetworkDiscoveryTest {
  ...
  private static HttpServer otherFooComServer;
  ...
  public void setUp() throws Exception {
    ...
    tofuServerURL = new URL("https://localhost:" + tofuServer.actualPort());
  ...
  @Test
  public void testServerWithSameCNAfterTOFU() throws Exception {
    testTOFU();
    URL unknownServerURL = new URL("https://localhost:" + otherFooComServer.actualPort());
    networkNodes.addNode(new SodiumPublicKey("pk3".getBytes(UTF_8)), unknownServerURL);
    Thread.sleep(2000);
    assertEquals(Instant.MIN, networkDiscovery.discoverers().get(unknownServerURL.toString()).lastUpdate);
  }
